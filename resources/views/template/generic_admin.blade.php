...
<head>
  <meta charset="UTF-8">
  <title>App | Virtual Colors | Alexander Londoño </title>
...
<body class="skin-blue">
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <!-- Logo -->
      <a href="{{ url('/') }}/admin/main" class="logo"><b>Admin </b>Laravel 5.1</a>
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li><a href="{{URL::to('/')}}/admin/roles" title="Roles">Roles</a></li>
          <li><a href="{{URL::to('/')}}/admin/company" title="Empresa">Empresas</a></li>
...
{{--           <li class="treeview">
    ...
    <footer class="main-footer">
      ...
      <!-- Default to the left -->
      <strong>Copyright © 2017 <a href="#">vituals Colors</a>.</strong> All rights reserved.
    </footer>
